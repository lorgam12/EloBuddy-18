...
namespace HoolaRiven
{
    public class Program
    {
      ...
      private static void OnGameLoad(EventArgs args)
        {
            ...
            E = new LeagueSharp.Common.Spell(SpellSlot.E, 300);
      ...
      private static void Combo()
        {
            var targetR = LeagueSharp.Common.TargetSelector.GetTarget(250 + Player.AttackRange + 70, LeagueSharp.Common.TargetSelector.DamageType.Physical);
      ...
      private static void Burst()
        {
            var target = LeagueSharp.Common.TargetSelector.GetSelectedTarget();
      ...
      private static void FastHarass()
        {
            ...
            {
                var target = LeagueSharp.Common.TargetSelector.GetTarget(450 + Player.AttackRange + 70, LeagueSharp.Common.TargetSelector.DamageType.Physical);
      ...
      private static void Harass()
        {
            var target = LeagueSharp.Common.TargetSelector.GetTarget(400, LeagueSharp.Common.TargetSelector.DamageType.Physical);
