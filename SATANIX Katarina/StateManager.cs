...
namespace SATANIXKatarina
{
    internal class StateManager
    {
        ...
        public static void Init()
        {
			...
			ComboMenu.Add("ComboLogic", new ComboBox(" Combo Logic ", 1, "Q>E>W", "E>Q>W", "Random/dynamic"));
		...
		private static void RandomCombo() //Random/dynamic Combo
		{
			...
			int value = GetRandomInt(0, 1); //gives random integer between 0 & 1
			
			value > 0 ? Combo1() : Combo2();
		}
